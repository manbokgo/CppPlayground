...
// 삽질 끝에 첫 코드를 디버깅해보니 최단 경로가 여러개 가능한데도 한 최단경로만 저장해놓아서
// 저장한 경로 속에서 mid1-mid2 간선을 못 찾으면 무한루프 돌아서 시간초과였다.

// 제출 전에도 최단 경로 여러 개가 가능하다는 건 알았는데, 틀렸습니다 뜨면 고쳐야지하고 안일하게 제출했다가
// 무한루프로 시간초과 뜬 걸, 아! 애초에 이 방법으론 시간복잡도가 안 되는거구나!하고 착각하고 삽질한거였다...
...
// st와 G(H)을 각각 시작점으로 다익스트라를 2(3)회 돌려서 푸는 법도 떠오르긴 했었지만
// 위에서 말한 시간 초과 위험에, 1번만 돌리고 경로 저장하면 되는데 굳이? 싶어서 안 했는데
// 다른 사람 코드 보니 시간 차이도 거의 없고, 이 방법은 헤멜만한 부분도 없었다. 후...
